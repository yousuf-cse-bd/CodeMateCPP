/**
 * @file 42_ProtectedMemberProtectedInherit.cpp
 * @author Md. Yousuf Ali (yousuf.cse17@gmail.com)
 * @brief Protected members and protected accessifier is accessed by derived class (multi-level inheritance)
 * @version 0.1
 * @date 2022-10-14
 * @since FriDday; 10:48 PM
